...
SimpleForm.setup do |config|
  text_input_classes = 'daisy-input w-full outline-none'
  ...
  config.wrappers :vertical_form, tag: 'div',
    ...
    b.wrapper :main, tag: 'label', class: text_input_classes do |wr|
      wr.use :label_text, wrap_with: { tag: 'span', class: 'daisy-label' }
      wr.use :input, class: text_input_classes, error_class: 'is-invalid mb-1', valid_class: 'is-valid'
    end
  ...
  # Custom Select
  config.wrappers :custom_select, tag: 'div',
                                  class: 'daisy-select mb-3',
                                  error_class: 'form-group-invalid',
                                  valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder, class: 'text-sm text-gray-500'
  ...
  # Custom date input
  config.wrappers :custom_date, tag: 'div',
                                  class: 'mb-3',
                                  error_class: 'form-group-invalid',
                                  valid_class: 'form-group-valid' do |b|
    b.use :html5
    ...
    b.wrapper :main, tag: 'label', class: text_input_classes do |wr|
      wr.use :label_text, wrap_with: { tag: 'span', class: 'daisy-label' }
      wr.use :input, class: 'min-w-28 text-right', error_class: 'is-invalid mb-1', valid_class: 'is-valid'
    end
  end
  ...
  config.wrappers :vertical_file, tag: 'div',
    ...
    b.optional :minlength
    b.optional :readonly
    b.use :label, class: 'daisy-label'
    b.use :input, class: 'w-full min-w-fit daisy-file-input',
                  error_class: 'is-invalid mb-1',
                  valid_class: 'is-valid'
    b.use :full_error,
          wrap_with: { tag: 'div',
